...
const TAG_OWNERS: Record<string, string> = {
  attachment: "issue-adjuncts",
  avatar: "coordinator",
  comment: "issue-adjuncts",
  ...
  worklog: "issue-adjuncts",
  role: "project-core",
  mypermissions: "project-core",
  universal_avatar: "coordinator",
  upgrade: "coordinator",
...
const TAG_CONTRACT_EXCEPTIONS: Record<string, string[]> = {
  attachment: ["See planning/issue-adjuncts-compatibility.md."],
  avatar: ["See contracts/COMPATIBILITY.md items 13-14."],
  ...
  "email-templates": ["See contracts/COMPATIBILITY.md item 16."],
  filter: ["See contracts/COMPATIBILITY.md items 11-12."],
  comment: ["See planning/issue-adjuncts-compatibility.md."],
  issue: ["See planning/issue-core-contract-notes.md."],
  issueLink: ["See planning/issue-adjuncts-compatibility.md."],
  ...
  jql: ["See planning/issue-adjuncts-compatibility.md."],
  ...
  project: ["See planning/project-core-contract-notes.md."],
  ...
  terminology: ["See contracts/COMPATIBILITY.md item 15."],
